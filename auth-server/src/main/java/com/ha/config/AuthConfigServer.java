...
import com.ha.security.CustomTokenService;
import com.ha.security.CustomTokenStore;
import com.ha.security.filter.BeforeClientCheckFilter;
import com.ha.security.filter.CustomBasicAuthenticationFilter;

@Configuration
@EnableAuthorizationServer
@EnableOAuth2Client
//@EnableOAuth2Sso
public class AuthConfigServer implements AuthorizationServerConfigurer{
    ...
    public AuthConfigServer(
    		final CustomTokenService tokenService,
...
//    	tt.setTokenStore(tokenStore);
    	endpoints
			...
			.accessTokenConverter(new AuthAccessTokenConverter());
    }
